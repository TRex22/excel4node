...
function init() {
  ...
  var reports = JSON.parse(fs.readFileSync(dir + config.reportsFile));
  var styleObj = JSON.parse(fs.readFileSync(dir + config.stylesFile));
...
function init(data) {
  ...
  if (config.testData) {
    /*Test Data*/
    var reports = JSON.parse(fs.readFileSync(dir + config.testReports));
    var styleObj = JSON.parse(fs.readFileSync(dir + config.testStyles));
